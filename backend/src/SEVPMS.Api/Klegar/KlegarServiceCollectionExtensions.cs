...
public static class KlegarServiceCollectionExtensions
{
    public static IServiceCollection AddKlegarBackend(this IServiceCollection services)
    {
        ...
        services.AddScoped<ISeatInventoryRepository, EfSeatInventoryRepository>(); services.AddScoped<ITicketRepository, EfTicketRepository>();
        services.AddScoped<ISeatService, SeatService>(); services.AddScoped<ITicketService, TicketService>();
