...
{
    /// <inheritdoc />
    public partial class AddCoreBusinessModules : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CheckoutReference = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Status = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    OwnerMessage = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_VenueRentalRequests", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_CheckoutReference",
                table: "Payments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Receipts_CustomerUserId",
                table: "Receipts",
                column: "CustomerUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VenueRentalRequests_OrganizerUserId",
                table: "VenueRentalRequests",
                column: "OrganizerUserId");

            migrationBuilder.CreateIndex(
                name: "IX_VenueRentalRequests_Status",
                table: "VenueRentalRequests",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_VenueRentalRequests_VenueId",
                table: "VenueRentalRequests",
                column: "VenueId");

            migrationBuilder.CreateIndex(
                name: "IX_VenueRentalRequests_VenueId_StartAtUtc_EndAtUtc",
                table: "VenueRentalRequests",
